...
const Footer = () => {
    return (
        <footer className="footer footer-center mt-24 p-10 bg-slate-300 text-black">
  ...
  <aside>
    ...
    Educational and Training Events Industries Ltd. <br/>Providing reliable services since 1992
    </p> 
    <p className="font-semibold">Copyright © 2023 - All right reserved by Jakir Hasan Rony</p>
  </aside> 
  {/* <nav>
